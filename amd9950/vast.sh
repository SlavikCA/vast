...
vastai list machine 147987 --price_gpu 0.36 --discount_rate 0.3 --price_min_bid 0.26 --price_disk 0.20 --price_inetu 0.006 --price_inetd 0.004 --vol_size 1000 --vol_price 0.20  --duration 2month
# --duration 2years
# --end_date 1784721600
