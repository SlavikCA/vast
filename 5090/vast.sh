...
vastai list machine 142067 --price_gpu 0.49 --discount_rate 0.3 --price_min_bid 0.30 --price_disk 0.20 --price_inetu 0.006 --price_inetd 0.004 --vol_size 1500 --vol_price 0.20  --duration 12month
# --end_date 1784721600
